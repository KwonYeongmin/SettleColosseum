...
public class ReflectionAura : MonoBehaviour
{
    ...
    public event EventHandler<CollisionInfo_> CollisionEnter;
    ...
    public void OnCollisionHandler(CollisionInfo_ e)
    {
...
public class CollisionInfo_ : EventArgs
{
